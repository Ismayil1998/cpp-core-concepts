...
/*
    Solution:
     yuxarida gosterilen metodlardan yalniz move() polimorfik ola biler cunki butun masin tipleri muxtelif cur herekt edir (sürətlənmə, dönmə) 
     amma diger metodlar ozune mexsus  getSpeed(), setSpeed(), getDirection(), setDirection(), getPosition() metodlari ola biler.
...
/*
    ...
    burdada hemcinin  calculateTax() calculateShipping() digerleri ancaq ozune mexsus duzelisler edib istifade olunur.
...
/*
    Solution:
    there manageUsers(),  postContent(), deleteContent() polimorfik olur.
